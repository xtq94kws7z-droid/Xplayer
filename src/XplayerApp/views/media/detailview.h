...
public:
  explicit DetailView(XplayerCore *core, QWidget *parent = nullptr);
...
private:
  ...
  executeFetchSecondaries(QPointer<DetailView> safeThis, XplayerCore *core,
  ...
  static QCoro::Task<void> executeLoadImages(QPointer<DetailView> safeThis,
                                             XplayerCore *core, MediaItem item,
  ...
  QString m_appliedOverviewSource;
  ...
  bool m_posterShadowReady = false;
